...
/**
 * We intentionally keep the public tooltip props loosely typed here.
 * Recharts has changed its TooltipContent prop types across versions,
 * while this shadcn-style wrapper relies on payload/label being available.
 */
...
function getPayloadConfigFromPayload(
  ...
  if (
    key in payloadObject &&
    typeof payloadObject[key] === "string"
  ) {
